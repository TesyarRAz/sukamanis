...
<div class="container bg-white p-5 shadow mt-3 mb-5 rounded">
    ...
    <hr />
    <form class="row g-3 d-flex justify-content-center align-items-center mt-4" method="POST" action="{{ route('surat.store', 'surat-domisili') }}" enctype="multipart/form-data">
        @csrf
        <div class="col-md-8">
