...
@section('content')
    <div class="container bg-white p-5 shadow mt-3 mb-5 rounded">
        ...
        <hr />
        <form class="row g-3 justify-content-center mt-4" method="POST" action="{{ route('surat.store', 'surat-beda-nama') }}"
            ...
            <p class="text-center text-muted mt-4">(Dalam.................................................................)
            </p>
            <hr />
            ...
            <div class="col-md-8">
                <label class="form-label">Tempat Lahir</label>
                <input name="tempat_lahir1" type="text" class="form-control @error('tempat_lahir1') is-invalid @enderror"
                    required>
                @error('tempat_lahir1')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="col-md-8">
                <label class="form-label">Tanggal Lahir</label>
                <input name="tanggal_lahir1" type="date"
                    class="form-control @error('tanggal_lahir1') is-invalid @enderror" required>
