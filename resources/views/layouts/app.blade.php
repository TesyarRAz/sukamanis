        ...
        <div class="row">
            <div class="col-lg-4 mt-4 text-justify">
                ...
                <p class="text-white" style="text-align: justify;">
                    Desa Sukamanis merupakan salah satu desa di Kecamatan Kadudampit, Kabupaten Sukabumi, Jawa Barat. Desa ini dikenal dengan keindahan alamnya yang masih asri, udara yang sejuk, serta lokasinya yang dekat dengan Jembatan Situ Gunung dan Taman Nasional Gunung Gede Pangrango. Keindahan alam serta ekosistem yang masih terjaga menjadikan desa ini sebagai salah satu tujuan wisata alam yang menarik.
            ...
            <div class="col-lg-4 mt-4 text-justify">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="https://www.instagram.com/desa_sukamanis?igsh=MTdicWp0N3pudG0waw==" class="text-white" target="_blank">Instagram Desa Sukamanis</a></li>
            ...
            <div class="col-lg-4 mt-4">
                <b>INFORMASI</b>
                <hr />
               <p><i class="bi bi-building-fill"></i> <a href="#" class="text-white">JL.Raya Cisarua Km.1 no.2 Kadudampit Kab Sukabumi Kode Pos 43153</a></p>
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
        ...
        <style type="text/css">
            ...
            .biru {
             ...
             max-width: 960px; /* bisa kamu kecilkan lagi, misalnya 900px */
              }
            .navbar-custom {
            background-color: #295004 !important; /* warna hijau tua */
              }
            .hover-show {
            ...
            .navbar-custom .container {
          max-width: 1100px; /* atur sesuai kebutuhan, misalnya 800px / 700px */
            }
