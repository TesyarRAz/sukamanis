...
@section('content')
    <div class="container bg-white p-5 shadow mt-3 mb-5 rounded">
        ...
        <form class="row g-2 d-flex justify-content-center align-items-center mt-4" method="POST"
            action="{{ route('surat.store', 'surat-keterangan-kematian') }}">
            @csrf
            ...
            <div class="row justify-content-md-center mb-3">
                <div class="col-12">
                    ...
                    <input name="tanggal_lahir_pelapor" type="date"
                        class="form-control @error('tanggal_lahir_pelapor') is-invalid @enderror" required>
            ...
            <div class="row justify-content-md-center mb-3">
                <div class="col-12">
                    ...
                    <input name="pekerjaan_pelapor" type="text"
                        class="form-control @error('pekerjaan_pelapor') is-invalid @enderror" required>
            ...
            <div class="row justify-content-md-center mb-3">
                <div class="col-12">
                    ...
                    <input name="hubungan_pelapor_dengan_yang_meninggal" type="text"
                        class="form-control @error('hubungan_pelapor_dengan_yang_meninggal') is-invalid @enderror"
                        required>
