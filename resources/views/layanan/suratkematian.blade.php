    ...
    <div class="container bg-white p-5 shadow mt-3 mb-5 rounded">
        ...
        <hr />
        <form class="row g-3" method="POST" action="{{ route('surat.store', 'surat-kematian') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    ...
                    @error('pada_tanggal')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-sm-6">
                    ...
                    @error('bertempat_di')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-sm-6">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    ...
                    @error('nik_pelapor')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-sm-6">
                    ...
                    @error('tempat_lahir_pelapor')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-sm-6">
                    <label class="form-label">pada tanggal pelapor</label>
                    <input name="pada_tanggal_pelapor" type="date" class="form-control @error('pada_tanggal_pelapor') is-invalid @enderror" required>
                    @error('pada_tanggal_pelapor')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-sm-12">
                    ...
                    @error('pekerjaan_pelapor')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="row mb-3">
                    <div class="col-sm-12">
                        <label class="form-label">hubungan pelapor dengan yang meninggal</label>
                        <textarea name="hubungan_pelapor_dengan_yang_meninggal" class="form-control @error('hubungan_pelapor_dengan_yang_meninggal') is-invalid @enderror" required></textarea>
                        @error('hubungan_pelapor_dengan_yang_meninggal')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
            </div>
